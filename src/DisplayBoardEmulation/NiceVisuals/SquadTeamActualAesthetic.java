...
if(!isRunning) {
	return;
					...
					for (double t = 0; t < 2 * Math.PI; t += 2 * Math.PI / 100) {
						...
						board.drawLine(22, 37, (int) (21 + 21 * Math.sin(t)), (int) (37 + 21 * Math.cos(t)), 50, 205,
								50);
						board.repaintBoard();
						wait(150);
						board.clear();
					...
					for (double t = Math.PI / 2; t < (3 * Math.PI) / 2; t += Math.PI / 100) {
						...
						board.drawLine(22, 72, (int) (21 + 21 * Math.sin(t)), (int) (72 + 21 * Math.cos(t)), 50, 205,
								50);
						board.drawLine(22, 1, (int) (21 + 21 * Math.sin(t + (Math.PI))),
								(int) (21 * Math.cos(t + (Math.PI))), 50, 205, 50);
						board.repaintBoard();
						wait(50);
						board.clear();
						if(!isRunning)return;
